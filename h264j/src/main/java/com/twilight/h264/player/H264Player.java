...
public class H264Player implements Runnable {
	...
	public static void main(String[] args) {
		new H264Player(new String[]{"/Users/alex.zhu/project/h264j-master/h264j/1.jpg"});
	}
...
//		frame.setSize(new Dimension(645, 380));
	...
	public boolean conver2Image(String filename) {
		H264Decoder codec;
		MpegEncContext c= null;
		FileInputStream fin = null;
		int frame, len;
				...
				try {
					while (avpkt.size > 0) {
						...
						if (got_picture[0]!=0) {
							...
							BufferedImage bfImage = new BufferedImage(imageWidth, imageHeight, BufferedImage.TYPE_INT_BGR);
							bfImage.setRGB(0, 0, imageWidth, imageHeight, buffer, 0, imageWidth);

							ImageIO.write(bfImage,"jpg",new File("/Users/alex.zhu/project/h264j-master/h264j/2.jpg"));
						}
						avpkt.size -= len;
						avpkt.data_offset += len;
					}
